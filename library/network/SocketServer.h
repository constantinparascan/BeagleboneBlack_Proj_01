...
private:
   ...
   int     portNumber;    // The port on which the server will listen 
   
   int 	   socketfd;      // The file descriptor of the soket returned by "socket(AF_INET, SOCK_STREAM, 0)" call
   ...
   /*
    * this array of pointers to connections 
    */
